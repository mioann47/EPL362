...
public class insertclient {
	...
	public static void insertpatientupdatelater(int id,String name,String address,String selfharm,String problem,String prev,String isalive
		...
		String response = target.path("insert").path("insertpatientupdatelater").queryParam("id", id).
	...
	public static void main(String[] args) {
		...
		insertpatientupdatelater(3, "dawd", "dawd", "1", "dawd", "1991-1-1", "1", "dawd", "1");
	}
