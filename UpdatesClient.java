...
public class UpdatesClient {
        ...
        public static void updateappointment (int id,int patient_id,int clinic_id,String date,String doctor){
            ClientConfig config = new ClientConfig();
            ...
            String response = target.path("updates").
                    ...
                    queryParam("clinic_id", clinic_id).queryParam("date", date).queryParam("doctor", doctor).
                            request().
                            accept(MediaType.TEXT_PLAIN).
                            get(Response.class)
                    .toString();
